...
all_words.update(line.strip() for line in open('hspell-kitlia.txt'))
...
missing_words = ['כורסא', 'ארצני' ,'משטור', 'עקידה', 'כאילו', 'האמנם', 'בגדול', 'הוביט', 'כושלה', 'רוגלה', 'נוזקה', 'חמודי', 'לומדה', 'תגילו', 'מטריל', 'גורון', 'הטריל', 'תטריל', 'אטריל', 'יטריל', 'פירות', 'בילוף', 'סתלבט', 'עוגיה', 'פרברי', 'אחלמה']
hard_words = ['לצפון']
